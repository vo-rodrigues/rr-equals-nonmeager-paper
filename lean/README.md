...
The [submission guide](docs/PALOMAR.md) describes the independent
[Challenge](Challenge.lean), proved [Solution](Solution.lean),
[Comparator configuration](comparator.json), and
[formalization metadata](formalization.yaml). The submitted principal result is **non(M) ≤ rr**.
The formalization was generated by OpenAI's GPT-6 Astra, as recorded in the [manuscript README](../paper/README.md).